                ...
                <div class="col-lg-9 order-lg-2">
                    <div class="row">
                        ...
                        @foreach($all_products as $data)
                            @if(optional($data->lang_front) != null)
                                <div class="col-lg-4 col-md-6">
                                    <div class="single-product-item-3 margin-bottom-30">
                                        <div class="thumb">
                                            <a href="{{route('frontend.products.single',['slug'=>optional($data->lang_front)->slug,'id'=>$data->id])}}">
                                                <div class="img-wrapper">
                                                    {!! render_image_markup_by_attachment_id($data->image,'','grid') !!}
                                                </div>
                                            </a>
                                            @if(!empty(optional($data->lang_front)->badge))
                                                <span class="tag">{{optional($data->lang_front)->badge}}</span>
                                            @endif
                                        </div>
                                        <div class="content">
                                            ...
                                            <a href="{{route('frontend.products.single',['slug'=>optional($data->lang_front)->slug ?? 'x','id'=>$data->id])}}">
                                                <h4 class="title">{{Str::words(optional($data->lang_front)->title,5)}}</h4>
                                            </a>
                        ...
                        <div class="widget widget_nav_menu product-widget">
                            ...
                            <ul class="product_category_list">
                                @foreach($all_category as $data)
                                    <li><a data-catid="{{$data->id}}" href="{{route('frontend.products.category',['id' => $data->id,'any' => Str::slug($data->category_front->name ?? 'x')])}}" @if($data->id == $selected_category) class="active" @endif>{{optional($data->category_front)->name}}</a></li>
                                @endforeach
                            </ul>
                        </div>
