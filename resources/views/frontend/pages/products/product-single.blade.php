...
@section('site-title')
    {{optional($product->lang_front)->title}}
@endsection
@section('page-title')
    {{optional($product->lang_front)->title}}   
@endsection
@section('page-meta-data')
<meta name="title" content="{{optional($product->lang_front)->meta_title}}">
<meta name="tags" content="{{optional($product->lang_front)->meta_tags}} ">
<meta name="description" content="{{optional($product->lang_front)->meta_description}}">
@endsection
@section('og-meta')
<meta name="og:title" content="{{optional($product->lang_front)->og_meta_title}}">
<meta name="og:description" content="{{optional($product->lang_front)->og_meta_description}}">
{!! render_og_meta_image_by_attachment_id(optional($product->lang_front)->og_meta_image) !!}
@php
        $post_img = null;
                        ...
                        <div class="top-content">
                            ...
                            <div class="product-summery">
                                ...
                                <div class="short-description">
                                    <p>{{optional($product->lang_front)->short_description}}</p>
                                </div>
                                ...
                                <div class="cat-sku-content-wrapper">
                                    ...
                                    <div class="share-wrap">
                                       <ul class="social-icons">
                                           ...
                                           {!! single_post_share(route('frontend.blog.single',['slug'=>optional($product->lang_front)->slug ?? 'x','id'=>$product->id]),$product->title,$post_img) !!}
                                       </ul>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade show active" id="nav-description" role="tabpanel">
                                        <div class="product-description">
                                            {!! optional($product->lang_front)->description !!}
                                        </div>
                                    </div>
                                    @if(!empty($product_attributes_title[0]))
                                    ...
                                    @foreach($related_products as $data)
                                        <div class="col-lg-3">
                                            <div class="single-product-item-3 margin-bottom-30">
                                                <div class="thumb">
                                                    <a href="{{route('frontend.products.single',['slug'=>optional($data->lang_front)->slug ?? 'x','id'=>$data->id])}}">
                                                        <div class="img-wrapper">
                                                            {!! render_image_markup_by_attachment_id($data->image,'','grid') !!}
                                                        </div>
                                                    </a>
                                                    @if(!empty(optional($data->lang_front)->badge))
                                                        <span class="tag">{{optional(optional($data->lang_front))->badge}}</span>
                                                    @endif
                                                </div>
                                                <div class="content">
                                                    <a href="{{route('frontend.products.single',['slug'=>optional(optional($data->lang_front))->slug ?? 'x','id'=>$data->id])}}">
                                                        <h4 class="title">{{optional(optional($data->lang_front))->title}}</h4>
                                                    </a>
                                                    ...
                                                    @else
                                                        <a href="{{route('frontend.products.add.to.cart')}}"
                                                           ...
                                                           data-product_title="{{optional($data->lang_front)->title}}"
