                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single-product-item-3 margin-bottom-30">
                            ...
                            <div class="content">
                                ...
                                @else
                                    <a href="{{route('frontend.products.add.to.cart')}}" class="addtocart ajax_add_to_cart" data-product_id="{{$data->id}}" data-product_title="{{optional($data->lang_front)->title}}" data-product_quantity="1"><i class="fa fa-shopping-bag" aria-hidden="true"></i>
