                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="product-info-wrap">
                                                <h4 class="product-title"><a href="{{route('frontend.products.single',['slug'=>$product_info->lang_front->slug ?? 'x', 'id'=>$product_info->id])}}">{{optional($product_info->lang_front)->title}}</a></h4>
