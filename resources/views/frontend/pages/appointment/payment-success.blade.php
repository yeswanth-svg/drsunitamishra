            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="order-success-area margin-bottom-80">
                        <h1 class="title text-center">{{get_static_option('appointment_booking_'.$user_select_lang_slug.'_success_page_title' )}}</h1>
                ...
                <div class="col-lg-8">
                    ...
                    <ul class="booking_details_list">
                        ...
                        <li><strong>{{__('Fre')}}</strong> : {{amount_with_currency_symbol($booking->total)}}</li>
                        ...
                        <li><strong>{{__('Booking Date')}}</strong> : {{date('D d, F Y',strtotime($booking->booking_date))}}</li>
                        <li><strong>{{__('Booking Time')}}</strong> : {{$booking->booking_time->time}}</li>
