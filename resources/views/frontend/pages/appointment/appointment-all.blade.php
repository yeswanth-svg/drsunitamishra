                        ...
                        <div class="right-part">
                            <select name="category" class="form-control">
                                ...
                                @foreach($category_list as $category)
                                    <option @if($category->id == $cat_id) selected @endif value="{{$category->id}}">{{optional($category->lang_front)->name}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="appointment-single-item">
                            ...
                            <div class="content">
                               <div class="top-part">
                                ...
                                <a href="{{route('frontend.appointment.single',['slug' => optional($data->lang_front)->slug ?? 'x', 'id' => $data->id])}}"><h4 class="title">{{optional($data->lang_front)->title}}</h4></a>
