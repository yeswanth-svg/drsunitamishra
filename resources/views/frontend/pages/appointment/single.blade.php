...
<meta name="title" content="{{optional($item->lang_front)->meta_title}}">
<meta name="tags" content="{{optional($item->lang_front)->meta_tags}} ">
<meta name="description" content="{{optional($item->lang_front)->meta_description}}">
@endsection
@section('og-meta')
<meta name="og:title" content="{{optional($item->lang_front)->og_meta_title}}">
<meta name="og:description" content="{{optional($item->lang_front)->og_meta_description}}">
{!! render_og_meta_image_by_attachment_id(optional($item->lang_front)->og_meta_image) !!}
@php
  $post_img = null;
                           ...
                           <div class="content">
                               ...
                               <div class="social-share-wrap">
                                   <ul class="social-share">
                                       {!! single_post_share(route('frontend.appointment.single',['slug' => optional($item->lang_front)->slug ?? 'x', 'id' => $item->id]),$item->title,get_attachment_url_by_id($item->image,'full')) !!}
                                   </ul>
                               </div>
                           </div>
                       </div>
