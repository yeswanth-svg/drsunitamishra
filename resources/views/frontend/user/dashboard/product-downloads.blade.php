                ...
                <table class="table table-striped">
                    ...
                    @foreach($downloads as $data)
                        <tr>
                            ...
                            <td>
                                <a href="{{route('frontend.products.single',[$data['slug'],$data['id']])}}"><h4 style="font-weight: 600;">{{$data['title']}}</h4></a>
                                <div>
                            ...
                            <td>
                                <a class="btn btn-xs btn-success btn-boxed style-01 margin-bottom-10" href="{{route('user.dashboard.download.file',$data['id'])}}"><i class="fas fa-download"></i>  {{__('Download File')}}</a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
