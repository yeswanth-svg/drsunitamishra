                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="product-info-wrap">
                                                <h4 class="product-title"><a href="{{route('frontend.products.single',[$product_info->lang_front->slug ?? 'x',$product_info->id])}}">{{$product_info->lang_front->title ?? __('untitled')}}</a></h4>
