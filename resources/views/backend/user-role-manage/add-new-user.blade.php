                        ...
                        <form action="{{route('admin.new.user')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <ul class="text-danger">
                                    <li>{{__('Editors ( Have access everything except user role manage/general settings/language   )')}}</li>
                                    <li>{{__('Admin ( Have access everything except user role manage )')}}</li>
                                    <li>{{__('Super_Admin ( Have everything access )')}}</li>
                                </ul>
                            </div>
                            <div class="form-group">
