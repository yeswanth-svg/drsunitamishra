        ...
        <div class="ordered-product-summery">
            ...
            <table class="table table-bordered">
                ...
                @foreach($cart_items as $item)
                    @php $product_info = \App\Products::with('lang')->find($item['id']);@endphp
                    @if($product_info)
                    <tr>
                        <td>
                        ...
                        <td>
                            <div class="product-info-wrap">
                                <h4 class="product-title"><a href="{{route('frontend.products.single',['slug'=>$product_info->lang->slug,'id'=>$product_info->id])}}">{{$product_info->lang->title}}</a></h4>
                    ...
                    @else
                     <tr>
                        <td colspan="2">{{__('product removed')}}</td>
                     </tr>
                    @endif
                @endforeach
                </tbody>
