                            ...
                            @foreach($all_lang as $data)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @else
                                        <x-custom-alert :msg="__('Are you sure to make this language as a default language?')" :url="route('admin.languages.default',$data->id)" :text="__('Make default')" :alerttype="'warning'" :alertbtntext="__('Make Default')"/>
