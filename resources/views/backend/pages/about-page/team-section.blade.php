                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.about.team.member')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="tab-content margin-top-30" id="nav-tabContent">
                                @foreach($all_languages as $key => $lang)
                                    <div class="tab-pane fade @if($key == 0) show active @endif" id="nav-home-{{$lang->slug}}" role="tabpanel" aria-labelledby="nav-home-tab">
                                        ...
                                        <div class="form-group">
                                            <label for="about_page_{{$lang}}_team_member_section_subtitle">{{__('Sub Title')}}</label>
                                            <input type="text" name="about_page_{{$lang->slug}}_team_member_section_subtitle" value="{{get_static_option('about_page_'.$lang->slug.'_team_member_section_subtitle')}}" class="form-control" id="about_page_{{$lang->slug}}_team_member_section_subtitle">
                                        </div>
                                    </div>
                                @endforeach
                            </div>
                            <div class="form-group">
                                ...
                                <input type="number" name="about_page_team_member_item" value="{{get_static_option('about_page_team_member_item')}}" class="form-control" id="about_page_team_member_item">
                            </div>
