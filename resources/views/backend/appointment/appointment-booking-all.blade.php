                                ...
                                @foreach($all_booking as $data)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <x-custom-alert :msg="__('Are you sure to approve this payment?')" :text="__('Approve Payment')" :url="route('admin.appointment.booking.approve.payment',$data->id)"/>
                                            @endif
...
<x-datatable.js/>
    <script>
        (function ($){
            "use strict";
            <x-bulk-action-js :url="route('admin.appointment.booking.bulk.action')" />
