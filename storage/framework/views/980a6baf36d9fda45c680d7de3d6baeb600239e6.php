<?php $__env->startSection('site-title'); ?>
    <?php echo e(optional($product->lang_front)->title); ?>
...
<meta name="title" content="<?php echo e(optional($product->lang_front)->meta_title); ?>">
<meta name="tags" content="<?php echo e(optional($product->lang_front)->meta_tags); ?> ">
<meta name="description" content="<?php echo e(optional($product->lang_front)->meta_description); ?>">
<?php $__env->stopSection(); ?>
<?php $__env->startSection('og-meta'); ?>
<meta name="og:title" content="<?php echo e(optional($product->lang_front)->og_meta_title); ?>">
<meta name="og:description" content="<?php echo e(optional($product->lang_front)->og_meta_description); ?>">
<?php echo render_og_meta_image_by_attachment_id(optional($product->lang_front)->og_meta_image); ?>
                        ...
                        <div class="top-content">
                            ...
                            <div class="product-summery">
                                ...
                                <div class="short-description">
                                    <p><?php echo e(optional($product->lang_front)->short_description); ?></p>
                                </div>
                                ...
                                <div class="cat-sku-content-wrapper">
                                    ...
                                    <div class="share-wrap">
                                       <ul class="social-icons">
                                           ...
                                           <?php echo single_post_share(route('frontend.blog.single',['slug'=>optional($product->lang_front)->slug ?? 'x','id'=>$product->id]),$product->title,$post_img); ?>
                            ...
                            <div class="extra-content-wrap">
                                <nav>
                                    <div class="nav nav-tabs" role="tablist">
                                        ...
                                        <?php
                                        $product_attributes_title = unserialize(optional($product->lang_front)->attributes_title);
                                        ?>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade show active" id="nav-description" role="tabpanel">
                                        <div class="product-description">
                                            <?php echo optional($product->lang_front)->description; ?>
                                    ...
                                    <?php if(!empty($product_attributes_title[0])): ?>
                                        <div class="tab-pane fade" id="nav-attributes" role="tabpanel">
                                            <?php
                                                $att_title = unserialize(optional($product->lang_front)->attributes_title);
                                                $att_descr = unserialize(optional($product->lang_front)->attributes_description);
                                            ?>
                                            ...
                                            <div class="single-product-item-3 margin-bottom-30">
                                                <div class="thumb">
                                                    ...
                                                    <?php if(!empty(optional($data->lang_front)->badge)): ?>
                                                        <span class="tag"><?php echo e(optional(optional($data->lang_front))->badge); ?></span>
                                                    <?php endif; ?>
                                                </div>
                                                <div class="content">
                                                    <a href="<?php echo e(route('frontend.products.single',['slug'=>optional(optional($data->lang_front))->slug ?? 'x','id'=>$data->id])); ?>">
                                                        <h4 class="title"><?php echo e(optional(optional($data->lang_front))->title); ?></h4>
                                                    </a>
                                                    ...
                                                    <?php else: ?>
                                                        <a href="<?php echo e(route('frontend.products.add.to.cart')); ?>"
                                                           ...
                                                           data-product_title="<?php echo e(optional($data->lang_front)->title); ?>"
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/drsunitamishra.com/public_html/resources/views/frontend/pages/products/product-single.blade.php ENDPATH**/ ?>