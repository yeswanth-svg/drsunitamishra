                        ...
                        <div class="col-lg-4">
                            <div class="appointment-single-item">
                                ...
                                <div class="content">
                                    ...
                                    <?php endif; ?>
                                    <a href="<?php echo e(route('frontend.appointment.single',['slug'=>optional($data->lang_front)->slug ?? 'x','id'=>$data->id])); ?>"><h4 class="title"><?php echo e($data->title); ?></h4></a>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/drsunitamishra.com/public_html/resources/views/frontend/pages/appointment/appointment-category.blade.php ENDPATH**/ ?>