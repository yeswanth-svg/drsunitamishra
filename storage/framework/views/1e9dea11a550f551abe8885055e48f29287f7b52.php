                            ...
                            <?php if(optional($data->lang_front) != null): ?>
                                <div class="col-lg-4 col-md-6">
                                    <div class="single-product-item-3 margin-bottom-30">
                                        <div class="thumb">
                                            <a href="<?php echo e(route('frontend.products.single',['slug'=>optional($data->lang_front)->slug,'id'=>$data->id])); ?>">
                                        ...
                                        <div class="content">
                                            ...
                                            <a href="<?php echo e(route('frontend.products.single',['slug'=>optional($data->lang_front)->slug ?? 'x','id'=>$data->id])); ?>">
                                                <h4 class="title"><?php echo e(Str::words(optional($data->lang_front)->title,5)); ?></h4>
                                            </a>
                        ...
                        <div class="widget widget_nav_menu product-widget">
                            ...
                            <ul class="product_category_list">
                                <?php $__currentLoopData = $all_category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li><a data-catid="<?php echo e($data->id); ?>" href="<?php echo e(route('frontend.products.category',['id' => $data->id,'any' => Str::slug($data->category_front->name ?? 'x')])); ?>" <?php if($data->id == $selected_category): ?> class="active" <?php endif; ?>><?php echo e(optional($data->category_front)->name); ?></a></li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
                        </div>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/drsunitamishra.com/public_html/resources/views/frontend/pages/products/products.blade.php ENDPATH**/ ?>