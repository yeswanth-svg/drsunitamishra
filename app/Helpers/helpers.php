...
function get_amount_in_inr($amount, $currency)
{
    ...
    $all_currency = [
        ...
        'AED' => 'د.إ', 'AFN' => '؋', 'ALL' => 'L', 'AMD' => '֏', 'ANG' => 'NAf', 'AOA' => 'Kz', 'ARS' => '$', 'AWG' => 'ƒ', 'AZN' => '₼', 'BAM' => 'KM', 'BBD' => 'Bds$', 'BDT' => '৳', 'BGN' => 'Лв', 'BMD' => '$', 'BND' => 'B$', 'BOB' => 'Bs', 'BSD' => 'B$', 'BWP' => 'P', 'BZD' => '$',
        'CHF' => 'CHf', 'CNY' => '¥', 'CLP' => '$', 'COP' => '$', 'CRC' => '', 'CZK' => 'Kč', 'DJF' => 'Fdj', 'DKK' => 'Kr', 'DOP' => 'RD$', 'DZD' => 'دج', 'EGP' => 'E£', 'ETB' => 'ብር', 'FJD' => 'FJ$', 'FKP' => '£', 'GEL' => 'ლ', 'GIP' => '£', 'GTQ' => 'Q',
        'GYD' => 'G$', 'HKD' => 'HK$', 'HNL' => 'L', 'HRK' => 'kn', 'HTG' => 'G', 'HUF' => 'Ft', 'ILS' => '₪', 'ISK' => 'kr', 'JMD' => '$', 'KGS' => 'Л', 'KHR' => '៛', 'KMF' => 'CF', 'KYD' => '$', 'KZT' => '₸', 'LAK' => '₭', 'LBP' => 'ل.ل.', 'LKR' => 'ரூ', 'LSL' => 'L',
        'MAD' => 'MAD', 'MDL' => 'L', 'MGA' => 'Ar', 'MKD' => 'Ден', 'MMK' => 'K', 'MNT' => '₮', 'MOP' => 'MOP$', 'MRO' => 'MRU', 'MUR' => '₨', 'MVR' => 'Rf', 'MXN' => 'Mex$', 'NAD' => 'N$', 'NIO' => 'C$', 'NOK' => 'kr', 'NPR' => 'रू', 'NZD' => '$', 'PAB' => 'B/.', 'PEN' => 'S/', 'PGK' => 'K',
        'PKR' => '₨', 'PLN' => 'zł', 'PYG' => '₲', 'QAR' => 'QR', 'RON' => 'lei', 'RSD' => 'din', 'RUB' => '₽', 'SAR' => 'SR', 'SBD' => 'Si$', 'SCR' => 'SR', 'SEK' => 'kr', 'SHP' => '£', 'SOS' => 'Sh.so.', 'SRD' => '$', 'SZL' => 'E', 'TJS' => 'ЅM',
        'TRY' => '₺', 'TTD' => 'TT$', 'TWD' => 'NT$', 'UAH' => '', 'UYU' => '$U', 'UZS' => 'so\'m', 'VND' => '₫', 'VUV' => 'VT', 'WST' => 'WS$', 'XCD' => '$', 'XPF' => '₣', 'YER' => '﷼', 'ZAR' => 'R'
    ];
...
function get_amount_in_ngn($amount, $currency)
{
    ...
    $all_currency = [
        ...
        'CHF' => 'CHf', 'CNY' => '¥', 'CLP' => '$', 'COP' => '$', 'CRC' => '₡', 'CZK' => 'Kč', 'DJF' => 'Fdj', 'DKK' => 'Kr', 'DOP' => 'RD$', 'DZD' => 'دج', 'EGP' => 'E£', 'ETB' => 'ብር', 'FJD' => 'FJ$', 'FKP' => '£', 'GEL' => 'ლ', 'GIP' => '£', 'GTQ' => 'Q',
        'GYD' => 'G$', 'HKD' => 'HK$', 'HNL' => 'L', 'HRK' => 'kn', 'HTG' => 'G', 'HUF' => 'Ft', 'ILS' => '₪', 'ISK' => 'kr', 'JMD' => '$', 'KGS' => 'Лв', 'KHR' => '៛', 'KMF' => 'CF', 'KYD' => '$', 'KZT' => '₸', 'LAK' => '₭', 'LBP' => 'ل.ل.', 'LKR' => 'ரூ', 'LSL' => 'L',
        'MAD' => 'MAD', 'MDL' => 'L', 'MGA' => 'Ar', 'MKD' => 'Ден', 'MMK' => 'K', 'MNT' => '₮', 'MOP' => 'MOP$', 'MRO' => 'MRU', 'MUR' => '', 'MVR' => 'Rf', 'MXN' => 'Mex$', 'NAD' => 'N$', 'NIO' => 'C$', 'NOK' => 'kr', 'NPR' => 'र', 'NZD' => '$', 'PAB' => 'B/.', 'PEN' => 'S/', 'PGK' => 'K',
        'PKR' => '₨', 'PLN' => 'zł', 'PYG' => '₲', 'QAR' => 'QR', 'RON' => 'lei', 'RSD' => 'din', 'RUB' => '₽', 'SAR' => 'SR', 'SBD' => 'Si$', 'SCR' => 'SR', 'SEK' => 'kr', 'SHP' => '£', 'SOS' => 'Sh.so.', 'SRD' => '$', 'SZL' => 'E', 'TJS' => 'ЅM',
        'TRY' => '₺', 'TTD' => 'TT$', 'TWD' => 'NT$', 'UAH' => '₴', 'UYU' => '$U', 'UZS' => 'so\'m', 'VND' => '₫', 'VUV' => 'VT', 'WST' => 'WS$', 'XCD' => '$', 'XPF' => '₣', 'YER' => '﷼', 'ZAR' => 'R'
    ];
    foreach ($all_currency as $cur => $symbol) {
    ...
    foreach ($menu_content as $menu_item) {
        ...
        if ($menu_item->ptype == 'static') {
            ...
            if (!empty($page_details)){
                $menu_title = optional($page_details->lang_front)->title;
                $menu_slug = route('frontend.dynamic.page', [optional($page_details->lang_front)->slug ?? 'x',$page_details->id]);
                $li_class .= (request()->is(route('frontend.dynamic.page', [$page_details->lang_front->slug ?? 'x',$page_details->id]))) ? ' current-menu-item ' : '';
            }
            ...
            if ($menu_item->ptype == 'service') {
                ...
                if (!empty($page_details)){
                    $menu_title = opttional($page_details->lang_front)->title;
                    $menu_slug = route('frontend.services.single', [$page_details->lang_front->slug ?? 'x',$page_details->id]);
                    $li_class .= (request()->is(route('frontend.services.single', [$page_details->lang_front->slug ?? 'x',$page_details->id]))) ? ' current-menu-item ' : '';
                }
                ...
                if (!empty($page_details)){
                    $menu_title = opttional($page_details->lang_front)->title;
                    $menu_slug = route('frontend.blog.single', [$page_details->lang_front->slug ?? 'x',$page_details->id]);
                    $li_class .= (request()->is(route('frontend.blog.single', [$page_details->lang_front->slug ?? 'x',$page_details->id]))) ? ' current-menu-item ' : '';
                }
                ...
                if (!empty($page_details)){
                    $menu_title = opttional($page_details->lang_front)->title;
                    $menu_slug = route('frontend.products.single', [$page_details->lang_front->slug ?? 'x',$page_details->id]);
                    $li_class .= (request()->is(route('frontend.products.single', [$page_details->lang_front->slug ?? 'x',$page_details->id]))) ? ' current-menu-item ' : '';
                }
                ...
                if (!empty($page_details)){
                    $menu_title = opttional($page_details->lang_front)->title;
                    $menu_slug = route('frontend.appointment.single', [$page_details->lang_front->slug ?? 'x',$page_details->id]);
                    $li_class .= (request()->is(route('frontend.appointment.single', [$page_details->lang_front->slug ?? 'x',$page_details->id]))) ? ' current-menu-item ' : '';
                }
            }
                ...
                if($menu_item->ptype == 'product_mega_menu'){
                    foreach ($mega_menu_items as $cat => $posts) {
                        ...
                        foreach ($posts as $post) {
                            $mega_menu_item_slug = get_mege_menu_item_url($menu_item->ptype,$post->lang_front->slug ?? 'x',$post->id);
...
function render_submenu_children($menu_children)
{
    ...
    foreach ($menu_children as $menu_item) {
        ...
        if ($menu_item->ptype == 'static') {
            ...
            $page_details = Page::with('lang_front')->find($menu_item->pid);
            $menu_title = !empty($page_details) ? optional( $page_details->lang_front)->title: '';
            $menu_slug = !empty($page_details) ? route('frontend.dynamic.page', [$page_details->lang_front->slug ?? 'x',$page_details->id]) : '';
            if (!empty($page_details)){
                $li_class .= (request()->is(route('frontend.dynamic.page', [$page_details->lang_front->slug ?? 'x',$page_details->id])))   ? ' current-menu-item ' : '';
            }
        } elseif ($menu_item->ptype == 'custom') {
            ...
            if ($menu_item->ptype == 'service') {
                ...
                if(!empty($page_details)){
                    $menu_title = optional($page_details->lang_front)->title;
                    $menu_slug = route('frontend.services.single', [$page_details->lang_front->slug ?? 'x', $page_details->id]);
                    $li_class .= (request()->is(route('frontend.services.single', [$page_details->slug ?? 'x', $page_details->id]))) ? ' current-menu-item ' : '';
                }
                ...
                if(!empty($page_details)){
                    $menu_title = optional($page_details->lang_front)->title;
                    $menu_slug = route('frontend.blog.single', [optional($page_details->lang_front)->slug ?? 'x',$page_details->id]);
                    $li_class .= (request()->is(route('frontend.blog.single', [$page_details->lang_front->slug ?? 'x',$page_details->id]))) ? ' current-menu-item ' : '';
                }
...
function render_draggable_menu_by_id($id)
{
    ...
    foreach ($menu_data as $menu) :
        ...
        if ($menu->ptype == 'static') {
            ...
            $menu_title = !empty($menu_details) ? optional($menu_details->lang_front)->title : '';
        ...
        if (!empty($mega_menu_enable)) {
            ...
            foreach ($mega_menu_items as $data) :
                ...
                $output .= '<option value="' . $data->id . '" ' . $selected . ' >' . purify_html(optional($data->lang_front)->title) . '</option>';
            endforeach;
            $output .= '</select>';
            $mega_menu_enable = '';
        } else {
...
function render_mega_menu_item_select_markup($type = '',$menu_id = null)
{
    ...
    if (!empty($type)) {
        ...
        $output .= '<select name="items_id" multiple class="form-control">';
        foreach ($mega_menu_items as $data):
            $output .= '<option value="' . $data->id . '" >' . purify_html(optional($data->lang_front)->title) . '</option>';
        endforeach;
        $output .= '</select>';
    }
    return $output;
...
function get_mega_menu_cat_name_by_id($type, $cat_id)
{
    ...
    switch ($type) {
        case('service_mega_menu'):
            ...
            $return_val = !empty($cat_details) ? purify_html(optional($cat_details->lang_front)->name) : '';
            break;
...
function get_product_category_by_id($id,$type = ''){
    ...
    if (!empty($prod_cat)){
        $return_val = optional($prod_cat->lang_front)->name;
        if ($type == 'link' ){
            $return_val = '<a href="'.route('frontend.products.category',['id' => $prod_cat->id,'any' => Str::slug(optional($prod_cat->lang_front)->name ?? 'x') ]).'">'.optional($prod_cat->lang_front)->name.'</a>';
        }
    }
...
function render_cart_table()
{
    ...
    if (!empty($all_cart_item)) {
        ...
        foreach ($all_cart_item as $id => $item) {
            ...
            $output .= '<td><h4 class="product-title"><a href="' . route('frontend.products.single',['slug'=>$single_product->lang_front->slug ?? 'x','id'=>$single_product->id]) . '">' . optional($single_product->lang_front)->title . '</a></h4></td>';
