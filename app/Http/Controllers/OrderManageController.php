...
class OrderManageController extends Controller
{
    ...
    public function order_view($id){
        ...
        return view('backend.package-order-manage.order-manage-view')->with(['order' => $order]);
    }
    ...
    public function completed_orders(){
        $all_orders = Order::where('status','complete')->get();
    ...
    public function payment_logs_view($id){
        ...
        return view('backend.payment-logs.payment-log-view')->with(['payment_log' => $payment_log]);
    }
